...
class LevelThree extends Phaser.Scene {
  ...
  create(){
    ...
    lavaTrap.create(270, 62, 'lava-md');
    ...
    ground.create(116, 62, 'ground-sm');
    ...
    ground.create(177, 50, 'platform');
    ground.create(200, 42, 'platform');
    ground.create(225, 30, 'platform');
    ground.create(245, 42, 'platform');
    ground.create(268, 30, 'platform');
    ground.create(324, 53, 'platform');
    ...
    var badguy2 = new Enemy(this, 177, 40);
    var badguy3 = new Enemy(this, 225, 20);
    var badguy4 = new Enemy(this, 268, 20);
    var badguy5 = new Enemy(this, 200, 30);

    this.enemies = [badguy, badguy2, badguy3, badguy4, badguy5];
  ...
  //Enemy movement
  if(Math.floor(time / 1500) > jumpTime){
    this.enemies.forEach(el => {
      if(el.active === true && el.body.touching.down){
        el.setVelocityY(-50);
        }
      });
      jumpTime = Math.floor(time / 1500)
  }

  if(Math.floor(time / 1800) > lastTime){
    this.enemies.forEach(el => {
      if(el.active === true){
    ...
    lastTime = Math.floor(time / 1800);
  }

  if((Math.round((time + 300)/ 1800) - lastTime)  > movementTimer){
