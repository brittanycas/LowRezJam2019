...
class LevelTwo extends Phaser.Scene {
  ...
  create(){
    ...
    ground.create(225, 35, 'platform');
    ground.create(245, 45, 'platform');
    ground.create(264, 53, 'platform');
    ...
    var badguy3 = new Enemy(this, 225, 25);
    var badguy4 = new Enemy(this, 294, 48);

    this.enemies = [badguy, badguy2, badguy3, badguy4];
